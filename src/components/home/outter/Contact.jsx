...
const Block = styled.div`
    ...
    textarea, input, button { background-color: transparent; width: 90%;outline: none; border: none; font-size: 1.2rem; margin: 20px auto 10px; font-family: 'Noto L';}
    textarea, input { border-bottom: 1px solid #919191;}
    button { 
        width: 100%; z-index:1; font-weight: bold;
