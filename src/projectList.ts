...
const projectList: Array<IProject> = [
    ...
    },
    {
        ...
        subTitle: ['# 해커톤 APPJAM 우수상 ', '# Node.js'],
    ...
    {
        title: 'pondan',
        duration: '2020.11.21 ~ 2020.11.22',
        subTitle: ['# hackaton'],
    ...
    },
    {
        ...
        link: 'tooc',
        summary: "IT 동아리 내에서 3주간의 해커톤을 진행하며, ‘여행객을 위한 짐 보관 서비스 플랫폼’을 서비스하는 모바일 어플리케이션을 제작했습니다. 정말 큰 도전이 필요한 프로젝트였습니다. 서버를 제작하는 것이 처음일 뿐만 아니라, 실제 서비스를 제작하는 협업 프로젝트가 처음이었기 때문에 도전정신과 열정으로 해결해 나아가려고 노력했습니다.",
