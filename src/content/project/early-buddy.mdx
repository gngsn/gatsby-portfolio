...
<div className="early-buddy">
    ...
    <section>
        <QuotationMarksTitle>
            APPJAM 해커톤 우수상. Node.js 서버 개발. 협업 능력
        </QuotationMarksTitle>
        <FlexBox align="center">
            ...
            {/* <SkillList width={30} height={30} padding={25} fontSize={1.5} list={['vscode', 'node', 'Express', 'mysql', 'git', 'github', 'aws', 'nginx']} /> */}
            <SkillList size={40} justify="flex-start">
            ...
            <LinkIcon target="_blank" href="https://github.com/EARLY-BUDDY/EARLY-BUDDY-SERVER">
                <img src="https://img.icons8.com/fluent/96/000000/github.png" /> 메인 서버
            </LinkIcon>
            </div>
        </FlexBox>
    </section>
    <section>
        ...
        <FlexBox>
            <div>
                ...
                <LinkIcon target="_blank" href="https://github.com/EARLY-BUDDY/EARLY-BUDDY-PUSH-SERVER">
                    <img style="width: 30px; height: 30px" src="https://img.icons8.com/fluent/96/000000/github.png" /> 알림 서버 (FCM)
                </LinkIcon>
            </div>
    ...
    <section>
        ...
        <p>
            ...
            <br /><br />
            일정을 수정하는 작업에서 데이터베이스 처리에 대한 문제가 생겼습니다. 경로 데이터를 모두 삭제하고 새로운 데이터를 넣는 해결책을 생각해내었고, 데이터를 찾는 것과 삭제하는 기능을 구현을 한 후에 두 기능을 가져와 수정 기능으로 만드니 해결할 수 있었습니다.
        </p>
    </section>
    <br /><br /><br />
</div>
